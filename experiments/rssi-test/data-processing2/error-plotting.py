...
def main():
    ...
    del locations['E'] # Remove entry E due to destroyed batteryconnectors on this receiver
    A = locations["A"]
    ...
    for g in range(len(g_list)):
        ...
        mse_list.append(mse_sum/len(tx_points))
    ...
    plt.grid()
    plt.legend()
    plt.savefig("../figures/norm_error_experiment2.png")
    plt.show()
